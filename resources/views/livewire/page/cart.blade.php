      ...
      <div class="flex flex-col md:flex-row gap-4">
          ...
          <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
            <table class="w-full">
              ...
              <tbody>
                ...
                @empty
                  <td colspan="5" class="text-center py-4 text-3xl font-semibold text-slate-500">
                    No items avaliable in cart!
                  </td>
                @endforelse
                <!-- More product rows -->
              </tbody>
        ...
        <div class="md:w-1/4">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            @if ($cart_items)
                <div class="mt-6">
                    <a href="/check-out" class="bg-blue-500 text-white py-2 px-4 inline-block text-center rounded-lg w-full">Checkout</a>
                </div>
            @endif
          </div>
        </div>
